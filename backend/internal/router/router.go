...
func wire(db *gorm.DB, cfg config.Config) handlers {
	...
	conflictService := service.NewConflictResolutionService(conflictRepository, windowRepository, stationRepository, assetRepository, backfillRepository, auditService, cfg.Weights)
