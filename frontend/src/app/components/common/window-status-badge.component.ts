...
@Component({
  ...
  styles: [`
    ...
    .locked, .pending_review, .needs_review, .partial { background: #fff2c7; color: #73550a; border-color: #dec778; }
    .allocated, .accepted, .archived, .success { background: #e0efe7; color: #205d45; border-color: #afd0be; }
    .cancelled, .rejected, .failed { background: #f6e2df; color: #8a352f; border-color: #dcaaa5; }
  `],
