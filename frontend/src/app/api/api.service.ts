...
import { ConflictResolution, DetectionResult, ContactBackfill, BackfillInput } from '../types/conflict';
...
export class ApiService {
  ...
  createBackfill(conflictId: number, input: BackfillInput): Observable<ApiEnvelope<ContactBackfill>> {
